...
const projects = [
  {
    img: "loginSystem.png",
    name: "Sistema de Login FullStack",
    link: "https://github.com/RyannBenjamim/login-system",
  },
  {
    img: "apiToDoList.png",
    name: "TodoList FullStack",
    link: "https://github.com/RyannBenjamim/ToDo-List-Express",
  },
  {
    img: "rymovies.png",
    name: "Rymovies",
    link: "https://ry-movies.netlify.app/",
  },
  {
...
projects.forEach((project) => {
  ...
  a.target = "_blank";
  a.innerHTML =
    '<div class="button"><i class="fa-solid fa-link"></i> Visualizar</div>';
